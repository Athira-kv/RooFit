...
// Wed Oct  9 00:31:17 2024 by ROOT version 6.32.06
...
#ifdef analyze_LH_cxx
analyze_LH::analyze_LH(TTree *tree) : fChain(0) 
{
...
analyze_LH::~analyze_LH()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_LH::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_LH::LoadTree(Long64_t entry)
{
...
void analyze_LH::Init(TTree *tree)
{
...
void analyze_LH::Show(Long64_t entry)
{
...
Int_t analyze_LH::Cut(Long64_t entry)
{
