...
#ifndef l_roofit_mom_h
#define l_roofit_mom_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   l_roofit_mom(TTree *tree=0);
   virtual ~l_roofit_mom();
...
#ifdef l_roofit_mom_cxx
l_roofit_mom::l_roofit_mom(TTree *tree) : fChain(0) 
{
...
l_roofit_mom::~l_roofit_mom()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t l_roofit_mom::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t l_roofit_mom::LoadTree(Long64_t entry)
{
...
void l_roofit_mom::Init(TTree *tree)
{
...
void l_roofit_mom::Show(Long64_t entry)
{
...
Int_t l_roofit_mom::Cut(Long64_t entry)
{
